...
Nova.booting(function (Vue, router) {
    Vue.component('index-array-images', __webpack_require__(3));
    Vue.component('detail-array-images', __webpack_require__(6));
    Vue.component('form-array-images', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    "span",
    {
      staticClass: "flex flex-row overflow-x-auto scrolling-touch",
      staticStyle: { width: "10rem" }
    },
    _vm._l(_vm.field.value, function(img) {
      return _c("img", {
        staticClass: "rounded h-8 mr-1",
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      ...
      _vm._l(_vm.field.value, function(img) {
        return _c("img", {
          staticClass: "rounded shadow-md mr-2",
          staticStyle: { height: "8rem", width: "auto" },
          attrs: { src: img, alt: "image" }
        })
      }),
      0
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fileSelected: function fileSelected(event) {
            ...
            axios.post('/nova-vendor/array-images/upload', fd).then(function (res) {
                for (var i = 0; i < res.data.length; i++) {
                    app.images.push(res.data[i]);
                }
                app.value = app.images;
            });
        },
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
          ...
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.$refs.add_image.click()
              }
            }
          },
          [_vm._v("Upload Image")]
        ...
        _c(
          "div",
          { staticClass: "flex flex-col pt-8 text-center" },
          _vm._l(_vm.images, function(img, index) {
            return _c(
              "div",
              { staticClass: "w-1/2 p-2 mb-4 rounded shadow-lg" },
              [
                _c("p", [
                  _c("img", {
                    staticClass: "rounded",
